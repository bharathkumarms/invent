                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3">
                            ...
                            <div class="form-bottom" style="margin-top:140px">
                                <form id="loginForm">
                                ...
                                <span style="font-size: 16px;margin-left: 17px;">Inventory Management Developed by <a href="http://www.jayasankaramsoft.in" target='_blank' class="text-primary">Jayasankaram</a> (2019)</span>
                            </div>
                        </div>
                    </div>
                    
                   <!-- <div class="row">
                        <div class="col-sm-12 text-center" style="color:white; font-size:18px">
                            Inventory Management Developed by <a href="http://www.jayasankaramsoft.in" target='_blank' class="text-primary">Jayasankaram</a> (2019)
                        </div>
                    </div>-->
                </div>
            </div>
